...
import { Calendar, Users, CheckSquare, TrendingUp, DollarSign, Home } from 'lucide-react';
...
const tasks = [
  { title: 'Property viewing at 123 Oak Street', time: '2:00 PM', completed: false },
  { title: 'Client meeting with John Smith', time: '3:30 PM', completed: false },
  { title: 'Update listing photos for 456 Pine Ave', time: '4:00 PM', completed: true },
  { title: 'Follow up with potential buyers', time: '5:00 PM', completed: false },
];
            ...
            <div className="space-y-6">
              {[1, 2, 3].map((_, index) => (
                <div key={index} className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-900">New client inquiry for 789 Maple Drive</p>
